...
- Norwegian Polar Institute - geology (#map-layers/geology)
- Norwegian Polar Institute - basemap
- Seimic
- Sedimentary logs
- Drone footage 
- Photo spheres (#map-layers/photo-spheres)
- Boreholes
- [Virtual outcrop Models](#map-layers/virtual-outcrop-models)
- Virtual Field Guides (#map-layers/virtual-field-guides)
